  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center overflow-hidden ${isDarkMode ? 'bg-black text-white' : 'bg-gray-200 text-black'}`}>
      ...
      <div className="absolute top-4 right-4 flex space-x-4">
        ...
        <a href='https://github.com/notcoderguy/age-tracker' target='_blank' rel='noopener noreferrer' className={`text-${isDarkMode ? 'white' : 'gray-600'} hover:text-${isDarkMode ? 'gray-300' : 'gray-800'} focus:outline-none`} aria-label='github'>
        <button className={`text-${isDarkMode ? 'white' : 'gray-600'} hover:text-${isDarkMode ? 'gray-300' : 'gray-800'} focus:outline-none`} aria-label='settings'>
